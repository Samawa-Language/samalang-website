...
description: Start programming with SamaLang v1.0 — your first steps with the original 11-keyword release
---
...
Welcome to **SamaLang v1.0** — the original release where modern coding meets Samawa culture.
...
SamaLang v1.0 includes **11 keywords**:
...
Use `#` for single-line comments in SamaLang v1.0:
